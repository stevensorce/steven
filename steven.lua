...
if tonumber(msg.sender.user_id) == 1938256007 then
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(steven..'mrmilanorap:Channel:Join')}, },}}
